...
import LandingFooter from "../LoginPage/components/LoginFooter";
      ...
      <div className="l-content flex-grow-1 d-flex align-items-center justify-content-center">
        <Container>
          <Row className="justify-content-center">
            <Col md={8} lg={5}>
              <Card className="shadow-lg rounded-4 p-4 login-form-card">
                <Card.Body>
                  {/* LOGO PUS dan Judul */}
                  ...
                  <Form onSubmit={handleForgotPassword} noValidate>
                    ...
                    <Button
                      ...
                      disabled={loading}
                      aria-label="Kirim kode OTP untuk reset password"
                    >
                      {loading ? (
                        <>
                          <Spinner
