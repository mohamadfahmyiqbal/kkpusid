...
// --- DATA MOCKUP INVOICE (Dibiarkan sama) ---
...
// HELPER FUNCTION LOKAL UNTUK MENDAPATKAN RETURN KEY DARI TOKEN
const getReturnPageKey = (token) => {
  ...
  try {
    ...
    // Mengambil key 'return' dari payload, atau default ke 'dashboardPage'
...
export default function InvoicePage() {
  ...
  console.log(returnPageKey);

  // Handler untuk kembali ke halaman sebelumnya (DINAMIS)
