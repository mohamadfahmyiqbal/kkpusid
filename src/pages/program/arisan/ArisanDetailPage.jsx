            ...
            <Card className="shadow-lg border-0">
              <Card.Body className="p-4">
                ...
                <Row className="mb-4 small">
                  <Col xs={12} className="mb-2 d-flex justify-content-between">
                    ...
                    <span className="fw-bold">
                      {detailData.namaProgram || MOCK_ARISAN_DETAIL.namaProgram}
                    </span>
                  </Col>
                  <Col xs={12} className="mb-2 d-flex justify-content-between">
                    <span className="small text-muted">Target</span>
                    <span className="fw-bold">
                      {detailData.target || MOCK_ARISAN_DETAIL.target}
                    </span>
                  </Col>
                  <Col xs={12} className="mb-2 d-flex justify-content-between">
                    <span className="small text-muted">Jumlah Term</span>
                    <span className="fw-bold">
                      {detailData.jumlahTerm || MOCK_ARISAN_DETAIL.jumlahTerm}
                    </span>
                  </Col>
                  <Col xs={12} className="d-flex justify-content-between">
                    <span className="small text-muted">Periode</span>
                    <span className="fw-bold">
                      {detailData.periode || MOCK_ARISAN_DETAIL.periode}
                    </span>
                  </Col>
                </Row>
                <hr />
                ...
                <div className="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <span className="fw-bold">
                    {MOCK_ARISAN_DETAIL.biayaPerjalanan}
                  </span>
                </div>
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <span className="small text-muted">Jumlah Keberangkatan</span>
                  <span className="fw-bold">
                    {MOCK_ARISAN_DETAIL.jumlahKeberangkatan}
                  </span>
                </div>
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <span className="small text-muted">Target</span>
                  <span className="fw-bold">
                    {MOCK_ARISAN_DETAIL.targetSummary}
                  </span>
                </div>
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <span className="small text-muted">Term</span>
                  <span className="fw-bold">
                    {MOCK_ARISAN_DETAIL.termSummary}
                  </span>
                </div>
                <div className="d-flex justify-content-between align-items-center mb-2">
