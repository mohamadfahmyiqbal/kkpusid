      ...
      <Card className="premium-card premium-card-active border-0 text-white overflow-hidden shadow-lg">
        ...
        <Card.Body className="p-4 relative" style={{ zIndex: 2 }}>
          ...
          <div className="dc-saldo-display mb-4">
            <div className="small opacity-75 mb-1 fw-medium">Saldo Pembiayaan Aktif</div>
            <h2 className="fw-bold mb-0 text-white font-outfit card-amount-value" style={{ fontSize: '30px' }}>
              Rp {Number(approvedFinancing?.nominal_kredit || 0).toLocaleString("id-ID")}
            </h2>
          </div>
          ...
          <div className="row g-3 mb-4 pt-3 border-top border-white border-opacity-10 text-start">
            <div className="col-4">
              <div className="text-uppercase opacity-50 fw-bold mb-1 card-grid-label">PRODUK</div>
              <div className="fw-bold small text-white-90">Jual Beli</div>
            </div>
            <div className="col-4">
              <div className="text-uppercase opacity-50 fw-bold mb-1 card-grid-label">AKAD</div>
              <div className="fw-bold small text-white-90">{approvedFinancing?.description || 'Murabahah'}</div>
            </div>
            <div className="col-4">
              <div className="text-uppercase opacity-50 fw-bold mb-1 card-grid-label">TANGGAL MULAI</div>
              <div className="fw-bold small text-white-90">{approvedFinancing?.tx_date || 'Aktif'}</div>
            </div>
          </div>
